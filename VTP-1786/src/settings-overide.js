...
LocalisationSettings.lang_code = "de";
LocalisationSettings.success = "Super";
LocalisationSettings.failed = "Gescheitert";
LocalisationSettings.try_again = "Erneut versuchen";
LocalisationSettings.download = "Herunterladen";
LocalisationSettings.you_popped_all_the_bubbles = "Du hast alle Blasen geplatzt";
LocalisationSettings.you_didnt_pop_all_the_bubbles = "Du hast nicht alle Blasen geplatzt!";
LocalisationSettings.tap_where_you_want_to_throw = "Tippe an die Stelle, an die du werfen möchstest";
